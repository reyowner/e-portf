  ...
  const values = [
    {
      ...
      description:
        "I believe in creating solutions that truly serve users' needs and enhance their experience.",
    },
    {
      icon: Award,
    ...
    },
    {
      ...
      description:
        'I embrace change and quickly adjust to new challenges, technologies, and environments.',
    },
  ];
    ...
    >
      <div className="container mx-auto px-4">
        ...
        <div className="max-w-6xl mx-auto">
          {activeTab === 'overview' && (
            <div className="space-y-6 lg:space-y-0 lg:grid lg:grid-cols-2 lg:gap-12 lg:items-stretch">
              {/* My Story */}
              <div className="lg:flex lg:flex-col">
                <div className="bg-gray-800/80 backdrop-blur-sm rounded-2xl sm:rounded-3xl p-4 sm:p-6 lg:p-8 border border-gray-700/50 shadow-lg lg:flex-1 lg:flex lg:flex-col lg:justify-start">
              ...
              <div className="space-y-6 lg:space-y-8">
                <div className="bg-gray-800/80 backdrop-blur-sm rounded-2xl sm:rounded-3xl p-4 sm:p-6 lg:p-8 border border-gray-700/50 shadow-lg">
                  <h3 className="text-lg sm:text-xl lg:text-2xl font-bold text-blue-400 mb-4 sm:mb-6">
                    Quick Facts
                  </h3>
                    ...
                    {quickFacts.map((fact, index) => (
                      <div key={index} className="flex items-start space-x-3 sm:space-x-4 group">
                        ...
                        <div className="flex-1 min-w-0">
                          ...
                          <p className="text-gray-400 mt-1 text-xs sm:text-sm leading-relaxed">
                            {fact.value}
                          </p>
                        </div>
                      </div>
